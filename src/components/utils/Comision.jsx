...
const Concurso = ({modalidad,participacion,tipo_concurso,doc_bases,doc_guia,doc_req,fecha_ini,fecha_fin}) => {
    return (
        <div class="max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 m-6">
            <img class="object-cover object-center w-full h-56" src="https://www.upeu.edu.pe/wp-content/uploads/2016/05/Comvocatoria-Ordinaria-2016.jpg" alt="avatar" />
            ...
            <div class="flex items-center px-6 py-3 bg-gray-900">
                ...
                <h1 class="mx-3 text-lg font-semibold text-white">Categorización Docente 2021-I</h1>
            </div>

            <div class="px-6 py-4">
                <h1 class="text-xl font-semibold text-gray-800 dark:text-white">Descripcion</h1>
                ...
                <p class="py-2 text-gray-700 dark:text-gray-400">
                    ...
                    <br/>
                    Fechas : {fecha_ini} hasta {fecha_fin}
                ...
                <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                    ...
                    <a href={doc_bases} target="_blank" rel="noreferrer" class="px-2 text-sm">ver</a>
                </div>
                ...
                <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                    ...
                    <a href={doc_guia} target="_blank" rel="noreferrer" class="px-2 text-sm">ver</a>
                </div>
                ...
                <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                    ...
                    <a href={doc_req} target="_blank" rel="noreferrer" class="px-2 text-sm">ver</a>
                </div>
            </div>
        </div>
